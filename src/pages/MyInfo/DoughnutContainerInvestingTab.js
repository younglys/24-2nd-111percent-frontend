    ...
    <Container>
      ...
      <DoughnutList>
        <List>
          ...
          <Amount>{investingTab?.[0].price.toLocaleString('en')}원</Amount>
        </List>
        <List>
          <div>
          ...
          <Amount>{investingTab?.[1].price.toLocaleString('en')}원</Amount>
        </List>
        <List>
          <div>
          ...
          <Amount>{investingTab?.[2].price.toLocaleString('en')}원</Amount>
        </List>
      </DoughnutList>
    </Container>
  );
